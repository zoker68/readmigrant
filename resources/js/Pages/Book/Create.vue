...
<template>
    <Head title="Добавление новой книги"/>
       <div class="flex flex-col sm:justify-center items-center pt-6 sm:pt-0 pb-8">
            <h2 class="text-2xl font-bold tracking-tight text-gray-900">Добавление книги</h2>
        </div>
        <form @submit.prevent="form.post(route('book.store',country.id))" class="mt-6 space-y-6">
            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <div class="mt-5">
                    ...
                    <p class="mt-2 text-sm text-gray-600">Можете написать тут, почему вам понравилась эта книга или что-то, почему ее нужно прочитать.</p>
...
flex justify-center w-full px-4 transition bg-white border-2 border-gray-300 border-dashed rounded-md appearance-none cursor-pointer hover:border-gray-400 focus:outline-none">
            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <div class="mt-5">
                    ...
                    <p class="mt-2 text-sm text-gray-600">Можете написать тут, например сумму, которую Вы хотели бы получить за пользование книгой, либо какой-то залог, который хотели бы получить на время пользования книгой. Или же может Вас интересует обмен книгами?</p>
                    ...
                    <div class="mt-6 space-y-6">
                        <div class="relative flex gap-x-3">
                            ...
                            <div class="text-sm leading-6">
                                ...
                                <p class="text-gray-500">Отметьте галочкой, если хотите сейчас сделать книгу доступной для передачи</p>
                            </div>
                        </div>
                        <div class="relative flex gap-x-3">
                            <div class="flex h-6 items-center">
                                <input id="mailed" v-model="form.mailed" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                            </div>
                            <div class="text-sm leading-6">
                                <label for="mailed" class="font-medium text-gray-900">Отправка почтой по стране Вашего нахождения</label>
                                <p class="text-gray-500">Отметьте, если вы готовы отправить свою книгу почтой по стране Вашего нахождения</p>
                            </div>
                        </div>
                        <div class="relative flex gap-x-3">
                            <div class="flex h-6 items-center">
                                <input id="send_border" v-model="form.send_border" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                            </div>
                            <div class="text-sm leading-6">
            ...
            <div class="flex items-center gap-4">
                <PrimaryButton :disabled="form.processing">Добавить книгу</PrimaryButton>

                <Transition enter-from-class="opacity-0" leave-to-class="opacity-0" class="transition ease-in-out">
                    <p v-if="form.recentlySuccessful" class="text-sm text-gray-600">Книга добавлена.</p>
                </Transition>
            </div>
