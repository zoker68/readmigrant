                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Редактирование жанра - {{ $genre->title }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="card card-primary w-50">
                        <div class="card-header">
                            <h3 class="card-name">Редактирование жанра - {{ $genre->title }}</h3>
                        </div>
                        @if($errors->count() > 0)
                            <div class="m-3">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="title" type="text" class="form-control"
                                           placeholder="Полное название жанра" value="{{ old('title') ?? $genre->title }}">
                                </div>
                            </div>
